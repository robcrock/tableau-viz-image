import { FieldRoleType, FieldAggregationType, ColumnType, IncludeDataValuesOption } from './Namespaces/Tableau';
...
export interface DataSource {
     ...
     * @since 1.4.0
     *
     * @since 1.5.0 Use the `DataSourceUnderlyingDataOptions.includeDataValuesOption` option to optimize performance
     * by restricting the properties included in the returned DataValues.
     *
     * @since 1.5.0 Columns to include can be specified by id using the `DataSourceUnderlyingDataOptions.columnsToIncludeById` option.
     *
     * @param options  Collection of options to change the behavior of the call.
